    ...
    public function onKernelResponse(ResponseEvent $event)
    {
        ...
        */
        ...
        $newHtmlContent = str_replace(
            ...
            '<div id="broadcast_message" class="alert alert-danger">Maintenance prévue lundi 25 Avril à 17h00</div>',
            $htmlContent);
        // Pour que cela apparaise partout même dans le profiler
        $newHtmlContent = str_replace(
            '<body>', 
            '<body><div id="broadcast_message" class="alert alert-danger">Maintenance prévue lundi 25 Avril à 17h00</div>',
            $htmlContent);
