 ...
 */
final class Version20220408071852 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE review ADD CONSTRAINT FK_MOVIE_REVIEW FOREIGN KEY (movie_id) REFERENCES movie (id)');
    }
